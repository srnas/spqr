...
void MC_integrate(int, double **, double **, double **);
void MC_update_positions(double **, double **, double **, int);
void MC_eval_displacement(int, double **, double **, double **, int, double, double, double);
...
int MC_calculate_local_energy(double *, double *, double *, int, double *);
