...
double MC_reduce_ermsd(int, int);
double MC_reduce_ermsd_trial(int, int);
double ermsd_norm(double *);
double get_ermsd();
double get_first_ermsd(double **, double **, double **, int);
double get_current_ermsd(double **, double **, double **, int);
